...
def isSubsetSum(arr, n, s1, s2):
    ...
    return (isSubsetSum(arr, n-1, s1, s2) or isSubsetSum(arr, n-1, s1-arr[n-1],s2) or isSubsetSum(arr,n-1,s1,s2-arr[n-1]))
...
def findPartion(arr):
    ...
    part_sum1 = part_sum
    part_sum2 = part_sum
    return isSubsetSumDP(arr, n, part_sum1, part_sum2)


print(findPartion([3,3,3]))
